package com.vaca.glx3;

import android.content.Context;
import android.opengl.GLES20;

import com.vaca.glx3.glkit.BufferUtils;
import com.vaca.glx3.glkit.ShaderProgram;
import com.vaca.glx3.glkit.ShaderUtils;
...
public class Square {
    ...
    public void draw() {
        ...
        shader.enableVertexAttribute("a_Position2");
        shader.setVertexAttribute("a_Position2", COORDS_PER_VERTEX, GLES20.GL_FLOAT, false, vertexStride, 0);

        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, vertexBufferId);
        GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0, vertexCount);

        shader.disableVertexAttribute("a_Position2");
